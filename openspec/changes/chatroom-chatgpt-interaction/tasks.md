...
- [x] 1.2 Add the fixed `host` role and Persona metadata to the chatroom mode definition, then add catalog and participant-projection tests for new and legacy meetings.
