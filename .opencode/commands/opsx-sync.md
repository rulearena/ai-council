...
**AI Council hard gate:** STOP unless the merged change passed Codex Gate B, Human Owner explicitly accepted it, `spec.md` §15 records `accepted / done`, and this command is running in the dedicated post-acceptance closeout worktree. Sync is acceptance closeout, not implementation readiness. Never write directly on main; the closeout commit requires independent Codex review before exact-HEAD merge.
